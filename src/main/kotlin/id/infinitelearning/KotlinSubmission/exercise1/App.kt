...
fun myProfile() {
    val firstName: String = "Monalisa"
    val lastName : String = "Depari"
    val umur = 21
    val Single = true
    val Tidak = false
 ...
 */
fun myName(): String {
    val grupMember:String = "Mona, Siti, Thomi, Lumban, Zainul"
    println("Nama anggota grup saya = $grupMember")
    return "Monalisa Br Sembiring Depari"
}
...
fun main() {
     ...
     *
     */
    groupDetail(7, listOf("Mona", "Siti", "Thomi", "Lumban", "Zainul"), "Afternoon")
